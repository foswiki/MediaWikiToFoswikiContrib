...
sub main {
    ...
    unless (
        defined
        $Foswiki::Contrib::MediaWikiToFoswikiContrib::Converter::language{
            $args{language} } )
    {
        print STDERR
          "ERROR: unknown language $args{language}. Known languages are: "
          . join( ', ',
            sort keys %Foswiki::Contrib::MediaWikiToFoswikiContrib::language )
          . "\n";
        exit;
    }
    ...
    my $converter =
      Foswiki::Contrib::MediaWikiToFoswikiContrib::Converter->new(%args);
